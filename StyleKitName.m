...
{
    [StyleKitName drawSuperGradientWithFrame: CGRectMake(0, 0, 355, 169) resizing: StyleKitNameResizingBehaviorStretch];
}
...
+ (void)drawSuperGradientWithFrame: (CGRect)targetFrame resizing: (StyleKitNameResizingBehavior)resizing
{
    ...
    //// Resize to Target Frame
    CGContextSaveGState(context);
    CGRect resizedFrame = StyleKitNameResizingBehaviorApply(resizing, CGRectMake(0, 0, 355, 169), targetFrame);
    CGContextTranslateCTM(context, resizedFrame.origin.x, resizedFrame.origin.y);
    CGContextScaleCTM(context, resizedFrame.size.width / 355, resizedFrame.size.height / 169);
    ...
    //// Page-1
    {
        //// Gradients
        {
            ...
            {
                //// path-2 Drawing
                UIBezierPath* path2Path = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(0, 0, 355, 169) cornerRadius: 5];
                [fillColor3 setFill];
                [path2Path fill];


                //// path- Drawing
                UIBezierPath* pathPath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(0, 0, 355, 169) cornerRadius: 5];
                CGContextSaveGState(context);
                [pathPath addClip];
                CGContextDrawLinearGradient(context, StyleKitName.gold,
                    CGPointMake(-0, 0),
                    CGPointMake(362.1, 170.69),
