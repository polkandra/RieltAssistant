...
//  RieltAssist
//
//  Created by Michael Kozlyukov on 27/10/2017.
...
+ (void)drawTableViewCellWithFrame: (CGRect)targetFrame resizing: (StyleKitNameResizingBehavior)resizing
{
    ...
    //// Color Declarations
    UIColor* gradientColor51 = [UIColor colorWithRed: 0.051 green: 0.396 blue: 0.847 alpha: 1];

    //// cell Drawing
    UIBezierPath* cellPath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(0, 0, 375, 100) cornerRadius: 20];
    [gradientColor51 setFill];
    [cellPath fill];
...
+ (void)drawVeryNewCell
{
    [StyleKitName drawVeryNewCellWithFrame: CGRectMake(0, 0, 375, 206) resizing: StyleKitNameResizingBehaviorStretch];
}

+ (void)drawVeryNewCellWithFrame: (CGRect)targetFrame resizing: (StyleKitNameResizingBehavior)resizing
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Resize to Target Frame
    CGContextSaveGState(context);
    CGRect resizedFrame = StyleKitNameResizingBehaviorApply(resizing, CGRectMake(0, 0, 375, 206), targetFrame);
    CGContextTranslateCTM(context, resizedFrame.origin.x, resizedFrame.origin.y);
    CGContextScaleCTM(context, resizedFrame.size.width / 375, resizedFrame.size.height / 206);


    //// Rectangle Drawing
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRoundedRect: CGRectMake(0, 0, 375, 206) cornerRadius: 28];
    [StyleKitName.gradientColor52 setFill];
    [rectanglePath fill];
