...
//  RieltAssist
//
//  Created by Michael Kozlyukov on 05.07.17.
...
+ (void)drawMeetingCell
{
    [StyleKitName drawMeetingCellWithFrame: CGRectMake(0, 0, 375, 100) resizing: StyleKitNameResizingBehaviorStretch];
}

+ (void)drawMeetingCellWithFrame: (CGRect)targetFrame resizing: (StyleKitNameResizingBehavior)resizing
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Rectangle Drawing
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRect: CGRectMake(0, 0, 375, 100)];
    CGContextSaveGState(context);
    [rectanglePath addClip];
    CGContextDrawLinearGradient(context, StyleKitName.gold, CGPointMake(187.5, -0), CGPointMake(187.5, 100), kNilOptions);
    CGContextRestoreGState(context);
